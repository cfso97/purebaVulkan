...
const formIds = {
  ...
  'LATAM': '',
  'LTD': '',
  'en': '2e85164b-eb32-4f47-8c41-e9a381349b5d',
  'es': '162a5e5d-fb47-47bc-af9c-3f18fab452a6', // Ejemplo: Reemplaza con tu ID real para 'es'
  'Default': '162a5e5d-fb47-47bc-af9c-3f18fab452a6' // Ejemplo: Reemplaza con tu ID por defecto
};

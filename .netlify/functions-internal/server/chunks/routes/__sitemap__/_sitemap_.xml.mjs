import { v as defineEventHandler, x as useSitemapRuntimeConfig, A as withoutLeadingSlash, B as withoutTrailingSlash, C as getRouterParam, h as createError, D as createSitemap } from '../../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
